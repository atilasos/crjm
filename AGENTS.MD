...
## Worker Identity
- Team: no-branch-crjm-vnext-corrige-o
- Worker: worker-1
- Role: executor
- Leader cwd: /Users/igor/dev/crjm
- Worktree root: /Users/igor/dev/crjm/.omx/team/no-branch-crjm-vnext-corrige-o/worktrees/worker-1
- Team state root: /Users/igor/dev/crjm/.omx/state
- Inbox path: /Users/igor/dev/crjm/.omx/state/team/no-branch-crjm-vnext-corrige-o/workers/worker-1/inbox.md
- Mailbox path: /Users/igor/dev/crjm/.omx/state/team/no-branch-crjm-vnext-corrige-o/mailbox/worker-1.json
- Leader mailbox path: /Users/igor/dev/crjm/.omx/state/team/no-branch-crjm-vnext-corrige-o/mailbox/leader-fixed.json
- Task directory: /Users/igor/dev/crjm/.omx/state/team/no-branch-crjm-vnext-corrige-o/tasks
- Worker status path: /Users/igor/dev/crjm/.omx/state/team/no-branch-crjm-vnext-corrige-o/workers/worker-1/status.json
- Worker identity path: /Users/igor/dev/crjm/.omx/state/team/no-branch-crjm-vnext-corrige-o/workers/worker-1/identity.json

## Protocol
1. Read your inbox at `/Users/igor/dev/crjm/.omx/state/team/no-branch-crjm-vnext-corrige-o/workers/worker-1/inbox.md`.
...
3. Send startup ACK before task work:
   ...
   `omx team api send-message --input "{"team_name":"no-branch-crjm-vnext-corrige-o","from_worker":"worker-1","to_worker":"leader-fixed","body":"ACK: worker-1 initialized"}" --json`
...
5. Read task files from `/Users/igor/dev/crjm/.omx/state/team/no-branch-crjm-vnext-corrige-o/tasks/task-<id>.json` using bare `task_id` values in APIs.
...
7. Use mailbox delivery flow:
   - `omx team api mailbox-list --input "{"team_name":"no-branch-crjm-vnext-corrige-o","worker":"worker-1"}" --json`
   - `omx team api mailbox-mark-delivered --input "{"team_name":"no-branch-crjm-vnext-corrige-o","worker":"worker-1","message_id":"<MESSAGE_ID>"}" --json`

...
- Generated at: 2026-03-21T10:23:13.094Z
- Games: 40
- Decisions: 1186
...
| --- | ---: | --- | --- |
| T1 N2 vs N1 | 40.0% | >= 60% | FAIL |
| T1 N3 vs N2 | 100.0% | >= 58% | PASS |
| T1 N4 vs N3 | 70.0% | >= 56% | PASS |
| T1 N5 vs N4 | 50.0% | >= 54% | FAIL |
| T2 N1 p50/p95 | 7.3ms / 102.4ms | p50 <= 100ms; p95 <= 2x p50 | FAIL |
| T2 N2 p50/p95 | 9.2ms / 212.9ms | p50 <= 250ms; p95 <= 2x p50 | FAIL |
| T2 N3 p50/p95 | 141.2ms / 501.3ms | p50 <= 500ms; p95 <= 2x p50 | FAIL |
| T2 N4 p50/p95 | 1000.2ms / 1001.1ms | p50 <= 1000ms; p95 <= 2x p50 | FAIL |
| T2 N5 p50/p95 | 2000.2ms / 2001.1ms | p50 <= 2000ms; p95 <= 2x p50 | FAIL |
| T3 legalidade | 100% legal | 100% legal | PASS |
| T4 estabilidade | 36.62% divergência | <= 15% | FAIL |

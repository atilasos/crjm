...
- Generated at: 2026-03-22T09:23:43.495Z
- Games: 80
- Decisions: 2348
...
| T2 N1 p50/p95 | 4.8ms / 20.7ms | p50 <= 100ms; p95 <= 2x p50 | FAIL |
| T2 N2 p50/p95 | 5.7ms / 50.3ms | p50 <= 250ms; p95 <= 2x p50 | FAIL |
| T2 N3 p50/p95 | 100.1ms / 101.0ms | p50 <= 500ms; p95 <= 2x p50 | PASS |
| T2 N4 p50/p95 | 200.2ms / 201.3ms | p50 <= 1000ms; p95 <= 2x p50 | PASS |
| T2 N5 p50/p95 | 400.1ms / 401.2ms | p50 <= 2000ms; p95 <= 2x p50 | PASS |
| T3 legalidade | 100% legal | 100% legal | PASS |
| T4 estabilidade | 0.24% divergência | <= 15% | PASS |

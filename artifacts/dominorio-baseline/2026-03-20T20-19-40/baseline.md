...
- Generated at: 2026-03-20T20:19:40.663Z
- Games: 8
- Decisions: 223
...
| --- | ---: | --- | --- |
| T1 N2 vs N1 | 0.0% | >= 60% | FAIL |
| T1 N3 vs N2 | 100.0% | >= 60% | PASS |
| T1 N4 vs N3 | 0.0% | >= 60% | FAIL |
| T1 N5 vs N4 | 50.0% | >= 60% | FAIL |
| T2 N1 p50/p95 | 5.0ms / 6.3ms | p50 <= 100ms; p95 <= 2x p50 | PASS |
| T2 N2 p50/p95 | 8.3ms / 14.7ms | p50 <= 250ms; p95 <= 2x p50 | PASS |
| T2 N3 p50/p95 | 25.2ms / 26.3ms | p50 <= 500ms; p95 <= 2x p50 | PASS |
| T2 N4 p50/p95 | 50.1ms / 51.3ms | p50 <= 1000ms; p95 <= 2x p50 | PASS |
| T2 N5 p50/p95 | 100.2ms / 101.2ms | p50 <= 2000ms; p95 <= 2x p50 | PASS |
| T3 legalidade | 100% legal | 100% legal | PASS |
| T4 estabilidade | 30.43% divergência | <= 5% | FAIL |

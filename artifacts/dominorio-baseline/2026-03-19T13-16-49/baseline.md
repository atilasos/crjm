...
- Generated at: 2026-03-19T13:16:49.305Z
- Games: 8
- Decisions: 234
...
| --- | ---: | --- | --- |
| T1 N2 vs N1 | 100.0% | >= 60% | PASS |
| T1 N3 vs N2 | 100.0% | >= 60% | PASS |
| T1 N4 vs N3 | 50.0% | >= 60% | FAIL |
| T1 N5 vs N4 | 50.0% | >= 60% | FAIL |
| T2 N1 p50/p95 | 5.1ms / 40.4ms | p50 <= 100ms; p95 <= 2x p50 | FAIL |
| T2 N2 p50/p95 | 7.5ms / 14.6ms | p50 <= 250ms; p95 <= 2x p50 | PASS |
| T2 N3 p50/p95 | 25.1ms / 26.4ms | p50 <= 500ms; p95 <= 2x p50 | PASS |
| T2 N4 p50/p95 | 50.1ms / 51.4ms | p50 <= 1000ms; p95 <= 2x p50 | PASS |
| T2 N5 p50/p95 | 100.1ms / 100.9ms | p50 <= 2000ms; p95 <= 2x p50 | PASS |
| T3 legalidade | 100% legal | 100% legal | PASS |
| T4 estabilidade | 37.50% divergência | <= 5% | FAIL |

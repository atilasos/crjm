...
- Generated at: 2026-03-19T14:21:10.675Z
- Games: 8
- Decisions: 243
...
| T1 N3 vs N2 | 50.0% | >= 60% | FAIL |
| T1 N4 vs N3 | 50.0% | >= 60% | FAIL |
| T1 N5 vs N4 | 50.0% | >= 60% | FAIL |
| T2 N1 p50/p95 | 4.4ms / 6.4ms | p50 <= 100ms; p95 <= 2x p50 | PASS |
| T2 N2 p50/p95 | 4.5ms / 13.5ms | p50 <= 250ms; p95 <= 2x p50 | FAIL |
| T2 N3 p50/p95 | 25.1ms / 26.1ms | p50 <= 500ms; p95 <= 2x p50 | PASS |
| T2 N4 p50/p95 | 50.1ms / 51.2ms | p50 <= 1000ms; p95 <= 2x p50 | PASS |
| T2 N5 p50/p95 | 100.1ms / 100.8ms | p50 <= 2000ms; p95 <= 2x p50 | PASS |
| T3 legalidade | 100% legal | 100% legal | PASS |
| T4 estabilidade | 50.00% divergência | <= 5% | FAIL |

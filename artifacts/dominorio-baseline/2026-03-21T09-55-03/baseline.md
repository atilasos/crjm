...
- Generated at: 2026-03-21T09:55:03.978Z
- Games: 8
- Decisions: 236
...
| T2 N1 p50/p95 | 4.5ms / 6.3ms | p50 <= 100ms; p95 <= 2x p50 | PASS |
| T2 N2 p50/p95 | 5.5ms / 14.4ms | p50 <= 250ms; p95 <= 2x p50 | FAIL |
| T2 N3 p50/p95 | 25.2ms / 26.1ms | p50 <= 500ms; p95 <= 2x p50 | PASS |
| T2 N4 p50/p95 | 50.1ms / 51.0ms | p50 <= 1000ms; p95 <= 2x p50 | PASS |
| T2 N5 p50/p95 | 100.1ms / 101.4ms | p50 <= 2000ms; p95 <= 2x p50 | PASS |

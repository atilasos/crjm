...
- Generated at: 2026-03-19T23:32:20.280Z
- Games: 32
- Decisions: 919
...
| T1 N4 vs N3 | 87.5% | >= 60% | PASS |
| T1 N5 vs N4 | 25.0% | >= 60% | FAIL |
| T2 N1 p50/p95 | 6.7ms / 100.3ms | p50 <= 100ms; p95 <= 2x p50 | FAIL |
| T2 N2 p50/p95 | 8.8ms / 181.2ms | p50 <= 250ms; p95 <= 2x p50 | FAIL |
| T2 N3 p50/p95 | 195.9ms / 501.2ms | p50 <= 500ms; p95 <= 2x p50 | FAIL |
| T2 N4 p50/p95 | 1000.2ms / 1001.1ms | p50 <= 1000ms; p95 <= 2x p50 | FAIL |
| T2 N5 p50/p95 | 2000.2ms / 2001.0ms | p50 <= 2000ms; p95 <= 2x p50 | FAIL |
| T3 legalidade | 100% legal | 100% legal | PASS |
| T4 estabilidade | 44.51% divergência | <= 5% | FAIL |

...
- Generated at: 2026-03-20T01:15:53.748Z
- Games: 8
- Decisions: 229
...
| T2 N1 p50/p95 | 5.1ms / 6.3ms | p50 <= 100ms; p95 <= 2x p50 | PASS |
| T2 N2 p50/p95 | 6.0ms / 14.3ms | p50 <= 250ms; p95 <= 2x p50 | FAIL |
| T2 N3 p50/p95 | 25.2ms / 26.5ms | p50 <= 500ms; p95 <= 2x p50 | PASS |
| T2 N4 p50/p95 | 50.2ms / 51.2ms | p50 <= 1000ms; p95 <= 2x p50 | PASS |
| T2 N5 p50/p95 | 100.1ms / 100.6ms | p50 <= 2000ms; p95 <= 2x p50 | PASS |
| T3 legalidade | 100% legal | 100% legal | PASS |
| T4 estabilidade | 45.83% divergência | <= 5% | FAIL |

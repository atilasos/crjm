...
- Generated at: 2026-03-20T05:31:25.586Z
- Games: 32
- Decisions: 938
...
| T2 N1 p50/p95 | 5.1ms / 6.2ms | p50 <= 100ms; p95 <= 2x p50 | PASS |
| T2 N2 p50/p95 | 6.6ms / 14.3ms | p50 <= 250ms; p95 <= 2x p50 | FAIL |
| T2 N3 p50/p95 | 25.1ms / 26.5ms | p50 <= 500ms; p95 <= 2x p50 | PASS |
...
| T4 estabilidade | 39.76% divergência | <= 5% | FAIL |

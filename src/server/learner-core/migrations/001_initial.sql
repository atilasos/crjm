...
-- Infra operacional para bootstrap técnico de sessão; não faz parte do núcleo canónico V1.
...
-- Infra operacional para cutover/import legado idempotente; não faz parte do núcleo canónico V1.

...
import type { ProdutoState, JogadaDupla } from '../types';
...
export function buildQuickReviewItems(
  history: Array<AIResponseV1<JogadaDupla, ProdutoState>>,
): QuickReviewItem[] {
  ...
  const unique = new Map<string, AIResponseV1<JogadaDupla, ProdutoState>>();
